...
PROGNAME = TouhouTetris

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o font.o mylib.o text.o title.o cirno1.o cirno2.o reimu1.o reimu2.o alice.o aya.o marisa.o patchouli.o remi.o sakuya.o piece.o startscreen.o gameclear.o gameover.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h title.h cirno1.h cirno2.h reimu1.h reimu2.h alice.h aya.h marisa.h patchouli.h remi.h sakuya.h piece.h startscreen.h gameclear.h gameover.h
